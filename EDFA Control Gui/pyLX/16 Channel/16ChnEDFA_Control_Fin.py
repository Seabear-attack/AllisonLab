# -*- coding: utf-8 -*-
"""
Created on Thu Jun  8 11:51:20 2023
...
class Window(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.CreateButton_close_app()
        self.CreateButton_EDFA3_on()
        self.CreateButton_EDFA3_off()
        
        self.CreateButton_close_app()
        self.CreateButton_EDFA4_on()
        self.CreateButton_EDFA4_off()
        ...
        for i in range(len(ILX.EDFA3_channels)):
            self.Make_EDFA3_Interface(i)
        for i in range(len(ILX.EDFA4_channels)):
            self.Make_EDFA4_Interface(i)
    ...
    def CreateButton_EDFA3_on(self):
        button = QPushButton("EDFA3 On", self)
        # button.move(50,50)
        button.setGeometry(QRect(25, 475, 100, 25))
        button.setIcon(QtGui.QIcon(self.iconName))
        button.setIconSize(QtCore.QSize(40, 40))
        # button.setToolTip("<h2>This is Click Me button<h2>")
        button.clicked.connect(self.EDFA3_on)

    def CreateButton_EDFA3_off(self):
        button = QPushButton("EDFA3 Off", self)
        # button.move(50,50)
        button.setGeometry(QRect(25, 500, 100, 25))
        button.setIcon(QtGui.QIcon(self.iconName))
        button.setIconSize(QtCore.QSize(40, 40))
        # button.setToolTip("<h2>This is Click Me button<h2>")
        button.clicked.connect(self.EDFA3_off)
        
        
    def CreateButton_EDFA4_on(self):
        button = QPushButton("EDFA4 On", self)
        # button.move(50,50)
        button.setGeometry(QRect(25, 650, 100, 25))
        button.setIcon(QtGui.QIcon(self.iconName))
        button.setIconSize(QtCore.QSize(40, 40))
        # button.setToolTip("<h2>This is Click Me button<h2>")
        button.clicked.connect(self.EDFA4_on)

    def CreateButton_EDFA4_off(self):
        button = QPushButton("EDFA4 Off", self)
        # button.move(50,50)
        button.setGeometry(QRect(25, 675, 100, 25))
        button.setIcon(QtGui.QIcon(self.iconName))
        button.setIconSize(QtCore.QSize(40, 40))
        # button.setToolTip("<h2>This is Click Me button<h2>")
        button.clicked.connect(self.EDFA4_off)
    ...
    #Dynamically define EDFA3 Interface functions:
    def Make_EDFA3_Interface(self,index):
        def _EDFA3_line(self):
            line_edit = QLineEdit('0',self)
            line_edit.setGeometry(250, 475+index*25, 100, 25)
            line_label = QLabel('Ch. ' + str(ILX.EDFA3_channels[index]) + ': [mA]', self)
            line_label.setGeometry(150, 475+index*25, 100, 25)
            line_label.setWordWrap(False)
            line_edit.returnPressed.connect(lambda: EDFA3_line1_action(self))
            def EDFA3_line1_action(self):
                value_line1 = line_edit.text()
                ILX.LDI_set(ILX.EDFA3_channels[index], float(value_line1))
                self.beep()
        return _EDFA3_line(self)

    #Dynamically define EDFA4 Interface functions:
    def Make_EDFA4_Interface(self,index):
        def _EDFA4_line(self):
            line_edit = QLineEdit('0',self)
            line_edit.setGeometry(250, 650+index*25, 100, 25)
            line_label = QLabel('Ch. ' + str(ILX.EDFA4_channels[index]) + ': [mA]', self)
            line_label.setGeometry(150, 650+index*25, 100, 25)
            line_label.setWordWrap(False)
            line_edit.returnPressed.connect(lambda: EDFA4_line1_action(self))
            def EDFA4_line1_action(self):
                value_line1 = line_edit.text()
                ILX.LDI_set(ILX.EDFA4_channels[index], float(value_line1))
                self.beep()
        return _EDFA4_line(self)
    ...
    def CreateButton_close_app(self):
        ...
        # button.move(50,50)
        button.setGeometry(QRect(25, 775, 150, 25))
        button.setIcon(QtGui.QIcon(self.iconName))
        button.setIconSize(QtCore.QSize(40, 40))
        # button.setToolTip("<h2>This is Click Me button<h2>")
